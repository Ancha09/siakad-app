...
class LegacyListNavigation
{
    public function returnUrl(Request $request, string $listRoute): string
    {
        ...
        $allowed = ['search', 'q', 'mahasiswa_id', 'angkatan', 'semester', 'tahun_akademik', 'semester_akademik', 'fakultas_id', 'prodi_id', 'kelas_id', 'mata_kuliah_id', 'dosen_id', 'ruangan_id', 'hari', 'status', 'jenis', 'tahun', 'tanggal_mulai', 'tanggal_selesai', 'page'];
