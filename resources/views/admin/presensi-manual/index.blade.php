...
<div class="page-card">
    <div class="page-card-head">
        ...
        <a href="{{ route('admin.presensi-manual.create', ['return_url' => request()->fullUrl()]) }}" class="btn-primary">+ Input Absensi</a>
    </div>
    <div class="page-card-body">
    @include('admin.partials.legacy-filters', ['attendance' => true, 'resetRoute' => 'admin.presensi-manual.index'])
    <div class="table-wrap"><table>
        <thead><tr><th>No</th><th>Mahasiswa</th><th>Mata Kuliah</th><th>Periode</th><th>Tanggal/Pertemuan</th><th>Status</th><th>Dosen</th><th>Keterangan</th><th>Aksi</th></tr></thead>
        <tbody>@forelse($presensis as $item)<tr>
            ...
            <td><a href="{{ route('admin.presensi-manual.edit', ['presensi' => $item, 'return_url' => request()->fullUrl()]) }}" class="btn-outline">Edit</a>
        ...
        </tr>@empty<tr><td colspan="9" style="text-align:center;padding:30px">Belum ada absensi manual.</td></tr>@endforelse</tbody>
