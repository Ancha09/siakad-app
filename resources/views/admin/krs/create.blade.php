            ...
            <div class="krs-form-grid">
                ...
                <div class="form-group">
                    ...
                    <small style="color:#64748b;">
                        ...
                        Pilih mahasiswa yang akan mengambil mata kuliah.
                ...
                <div class="form-group">
                    ...
                    <small style="color:#64748b;">
                        ...
                        Jadwal terhubung dengan mata kuliah, dosen, dan kelas.
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        <option
                            value="Diambil"
                            {{ old('status', 'Diambil') == 'Diambil' ? 'selected' : '' }}
                        >
                            Diambil
                        </option>
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        <option
                            value="Ganjil"
                            {{ old('semester_akademik', 'Ganjil') == 'Ganjil' ? 'selected' : '' }}
                        >
                            Ganjil
                        </option>
                        ...
                        <option
                            value="Genap"
                            {{ old('semester_akademik') == 'Genap' ? 'selected' : '' }}
                        >
                            Genap
                        </option>
